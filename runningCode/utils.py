...
def main():
	...
	for f in os.listdir("/home/sachinsiby/Desktop/Projects/SPARQ/runningCode/ImagesToTest"):
		if '.png'in str(f):
			detectChargingStation("/home/sachinsiby/Desktop/Projects/SPARQ/runningCode/ImagesToTest/"+str(f))

'''

'''
def main():
	detectChargingStation('image47.png')
